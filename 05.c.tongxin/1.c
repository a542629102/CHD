...
mkfifo( "fifotest1", S_IWUSR|S_IRUSR|S_IRGRP|S_IROTH);
mkfifo("fifotest2",S_IWUSR|S_IRUSR|S_IRGRP|S_IROTH);
rfd = open( "fifotest1",O_RDONLY);
wfd =open("fifotest2",O_WRONLY);
